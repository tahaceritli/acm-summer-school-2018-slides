...
%\end{frame}
 ...
 \item record linkage: \say{UNITED STATES} and \say{United States of America}.
...
\item remove all the matching rows (hint: use the drop-down arrow in the column named \say{All}) and export the data to a csv file. 
\end{itemize}
